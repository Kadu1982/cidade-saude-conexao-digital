                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="fezes">Parasitológico de Fezes</SelectItem>
                      <SelectItem value="tsh">TSH - Hormônio da Tireoide</SelectItem>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      <SelectItem value="lab_central">Laboratório Central</SelectItem>
                      <SelectItem value="lab_ubs1">Laboratório UBS 1</SelectItem>
                      <SelectItem value="lab_ubs2">Laboratório UBS 2</SelectItem>
                      <SelectItem value="lab_terceirizado">Laboratório Terceirizado</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
