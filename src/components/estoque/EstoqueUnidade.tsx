...
const unidadesSaude = [
  ...
  { id: '2', nome: 'UBS Jardim das Flores', medicamentos: 38, insumos: 19, alertas: 1 },
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{unidade.medicamentos} itens</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Insumos:</span>
                      <span className="font-medium">{unidade.insumos} itens</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Alertas:</span>
                      <span className={`font-medium ${unidade.alertas > 0 ? 'text-red-600' : 'text-green-600'}`}>
                        {unidade.alertas}
                      </span>
                    </div>
                  </div>
