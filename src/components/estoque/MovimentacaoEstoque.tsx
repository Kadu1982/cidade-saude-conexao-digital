...
export const MovimentacaoEstoque = () => {
  ...
  const handleRegistrarMovimentacao = () => {
    if (!novaMovimentacao.item || !novaMovimentacao.quantidade || !novaMovimentacao.motivo) {
      toast({
        title: "Erro",
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value: any) => setNovaMovimentacao({...novaMovimentacao, tipo: value})}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value: any) => setNovaMovimentacao({...novaMovimentacao, categoria: value})}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setNovaMovimentacao({...novaMovimentacao, item: e.target.value})}
              />
            </div>
