...
export const TriagemPaciente: React.FC = () => {
  ...
  const [pacienteSelecionado, setPacienteSelecionado] = useState<PacienteTriagem | null>(null);
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Cartão SUS: {paciente.cartaoSus} | Idade: {paciente.idade} anos
                        </p>
                      </div>
                      <div className="text-right">
                        <div className="flex items-center gap-2 text-sm text-gray-600">
                          <Clock className="h-4 w-4" />
                          <span>Recepcionado às {paciente.horarioRecepcao}</span>
                        </div>
                      </div>
                    </div>
                  </CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Aferição dos sinais vitais do paciente</CardDescription>
          </CardHeader>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setDadosTriagem({...dadosTriagem, pressaoArterial: e.target.value})}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setDadosTriagem({...dadosTriagem, temperatura: e.target.value})}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setDadosTriagem({...dadosTriagem, peso: e.target.value})}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setDadosTriagem({...dadosTriagem, altura: e.target.value})}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setDadosTriagem({...dadosTriagem, frequenciaCardiaca: e.target.value})}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setDadosTriagem({...dadosTriagem, saturacaoOxigenio: e.target.value})}
                  />
                </div>
              </div>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Queixa principal e classificação de risco</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => setDadosTriagem({...dadosTriagem, queixaPrincipal: e.target.value})}
              />
            </div>
            ...
            <div>
              ...
              <Select 
                ...
                onValueChange={(value: any) => setDadosTriagem({...dadosTriagem, prioridade: value})}
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => setDadosTriagem({...dadosTriagem, observacoes: e.target.value})}
              />
            </div>
          </CardContent>
        </Card>
