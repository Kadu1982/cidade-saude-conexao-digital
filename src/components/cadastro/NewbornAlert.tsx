...
export const NewbornAlert: React.FC<NewbornAlertProps> = ({ dataNascimento, nome }) => {
      ...
      <AlertDescription>
        {isExpired ? (
          <span className="text-red-600 font-medium">
            ⚠️ O prazo de 15 dias para atualização do cadastro de {nome} já expirou! 
            É obrigatório atualizar as informações imediatamente.
          </span>
        ) : (
          <span>
            Este é um cadastro de recém-nascido. É obrigatório atualizar as informações 
            em até 15 dias após o nascimento. Restam {daysRemaining} dias para atualização.
          </span>
        )}
      </AlertDescription>
    </Alert>
