...
export const ResumoAtendimentos = () => {
  const indicadores = [
    ...
    },
    {
      ...
      variacao: "+8%",
      tendencia: "up",
      descricao: "Atendimentos sem agendamento prévio"
    },
    {
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Indicadores PNAB - Mês Atual</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">{indicadoresPNAB.medicamentosDispensados}</p>
            </div>
            <div>
              <p className="font-medium">Vacinas Aplicadas</p>
              <p className="text-2xl font-bold text-green-600">{indicadoresPNAB.vacinasAplicadas}</p>
            </div>
            <div>
              <p className="font-medium">Visitas Domiciliares</p>
              <p className="text-2xl font-bold text-purple-600">{indicadoresPNAB.visitasDomiciliares}</p>
            </div>
            <div>
              <p className="font-medium">Cobertura ESF</p>
              <p className="text-2xl font-bold text-orange-600">{indicadoresPNAB.coberturaTerritorial}%</p>
            </div>
          </div>
        </CardContent>
      </Card>
