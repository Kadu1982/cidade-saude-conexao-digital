...
const VALIDACOES = [
  {
    id: "cnes-cns",
    nome: "CNES/CNS",
    descricao: "Vinculação obrigatória de procedimentos ao CNES executor e CNS do profissional",
    status: "aprovado",
    criticalidade: "alta",
    total: 1547,
    aprovados: 1547,
  ...
  },
  {
    id: "sigtap",
    nome: "SIGTAP",
    descricao: "Checagem automática das regras do SIGTAP por competência vigente",
    status: "pendente",
    criticalidade: "alta",
    total: 1547,
    aprovados: 1498,
      ...
      setProgresso((prev) => {
        if (prev >= 100) {
          ...
          toast({
            ...
            description: "Todas as validações automáticas foram executadas com sucesso.",
          });
          return 100;
        }
        return prev + 10;
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{totalGeral.toLocaleString()}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">{totalAprovados.toLocaleString()}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-red-600">{totalRejeitados.toLocaleString()}</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
                ...
                <CardContent className="p-4">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right text-sm">
                        <div className="font-medium">
                          {validacao.aprovados.toLocaleString()} / {validacao.total.toLocaleString()}
                        </div>
                        <div className="text-gray-500">
                          {validacao.rejeitados > 0 && `${validacao.rejeitados} rejeitados`}
                        </div>
                      </div>
                  ...
                  {validacao.rejeitados > 0 && (
                    <Alert className="mt-3">
                      ...
                      <AlertDescription>
                        <strong>{validacao.rejeitados} procedimentos rejeitados.</strong> 
          ...
          <Alert>
            ...
            <AlertDescription>
              <strong>Importação SIGTAP:</strong> Última atualização em 15/05/2024. 
              Próxima importação automática programada para 01/06/2024.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
