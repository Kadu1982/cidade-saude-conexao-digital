  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <Badge className={variants[status as keyof typeof variants] || "bg-gray-100 text-gray-800"}>
        {status === "disponivel" ? "Disponível" : status === "processando" ? "Processando" : "Erro"}
      </Badge>
    );
  };
      ...
      setProgresso((prev) => {
        if (prev >= 100) {
          ...
          toast({
            ...
            description: "Todos os arquivos magnéticos foram gerados com sucesso.",
          });
          return 100;
        }
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row gap-4 md:items-end">
        ...
        <Button onClick={handleGerarTodos} disabled={gerandoTodos} className="w-full md:w-auto">
          ...
          <CardContent className="p-4">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium">Gerando arquivos magnéticos...</span>
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <div className="font-medium">{arquivo.registros.toLocaleString()}</div>
                  </div>
                  <div>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          <div className="text-xs text-muted-foreground">
            Todos os arquivos são gerados conforme as especificações técnicas oficiais do Ministério da Saúde
            e passam por validação automática antes da disponibilização.
          </div>
        </CardContent>
      </Card>
    </div>
