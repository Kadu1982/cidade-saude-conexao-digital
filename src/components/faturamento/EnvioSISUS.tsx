...
import { CheckCircle2, ChevronRight, Clock, Send, Upload, XCircle } from "lucide-react";
...
const ENVIOS_ANTERIORES = [
  ...
  },
  {
    ...
    data: "05/03/2024",
    status: "aprovado",
    valorAprovado: 85630.00,
    valorRejeitado: 780.40,
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button onClick={handleEnviar} disabled={enviando}>
                  {enviando ? "Enviando..." : "Enviar"} <Send className="ml-1 h-4 w-4" />
                </Button>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b bg-muted/50">
                    <th className="p-2 text-left font-medium text-muted-foreground">Competência</th>
                    <th className="p-2 text-left font-medium text-muted-foreground">Data de Envio</th>
                    <th className="p-2 text-left font-medium text-muted-foreground">Status</th>
                    <th className="p-2 text-left font-medium text-muted-foreground">Valor Aprovado</th>
                    <th className="p-2 text-left font-medium text-muted-foreground">Protocolo</th>
                    <th className="p-2 text-right font-medium text-muted-foreground">Ações</th>
                  </tr>
                </thead>
                <tbody>
                  {ENVIOS_ANTERIORES.map((envio, index) => (
                    <tr key={index} className="border-b">
                      ...
                      <td className="p-2">R$ {envio.valorAprovado.toFixed(2)}</td>
