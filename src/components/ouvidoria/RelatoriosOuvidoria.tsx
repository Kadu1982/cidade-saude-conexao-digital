...
export const RelatoriosOuvidoria = () => {
  ...
  const relatoriosDisponiveis = [
    ...
    },
    {
      ...
      descricao: 'Análise dos prazos de atendimento',
      icon: Clock,
      tipo: 'performance'
    },
    {
  ...
  const gerarRelatorio = (relatorioId: string) => {
    console.log(`Gerando relatório: ${relatorioId} para período: ${periodoSelecionado}`);
    ...
    if (relatorio) {
      ...
      alert(`Relatório "${relatorio.titulo}" sendo gerado. Você receberá um e-mail quando estiver pronto.`);
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{estatisticasRapidas.totalManifestacoes}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{estatisticasRapidas.satisfacaoMedia}/5.0</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{estatisticasRapidas.tempoMedioResposta} dias</div>
            <p className="text-xs text-muted-foreground">
              Tempo de resposta
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{estatisticasRapidas.taxaCumprimentoPrazos}%</div>
            <p className="text-xs text-muted-foreground">
              Taxa de cumprimento
            </p>
          </CardContent>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 border rounded">
              <div>
                <div className="font-medium">Relatório Mensal de Manifestações</div>
            ...
            <div className="flex items-center justify-between p-3 border rounded">
              <div>
                <div className="font-medium">Relatório Trimestral de Satisfação</div>
                <div className="text-sm text-muted-foreground">
